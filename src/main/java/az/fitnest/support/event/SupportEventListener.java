package az.fitnest.support.event;
...
public class SupportEventListener {
    ...
    @KafkaListener(topics = "user-events", groupId = "support-user-events-group")
    @Transactional
    public void consumeUserEvent(String message) {
        try {
            ...
            if ("USER_HARD_DELETED".equals(eventType) && userIdObj != null) {
                ...
                if (userId != null) {
                    log.warn("Received USER_HARD_DELETED event for userId: {}. Deleting support tickets.", userId);
